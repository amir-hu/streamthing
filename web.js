...
app.use(express.static(path.join(__dirname, 'HTML'))) // lets us serve static files from the "public" directory
    .get('/', (req, res) => {                           // respond to HTTP GET request. '/' is the root endpoint.
        res.sendFile(path.join(__dirname, 'HTML/index.html')) // serve the landing static page
    })
